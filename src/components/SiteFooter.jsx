...
// Footer commun à toutes les pages ; la note d'actualisation automatique
// n'a de sens que sur la page statut (showRefreshNote)
export function SiteFooter({ showRefreshNote = false }) {
